<template>
  <view class="u-select" >
    ...
    >
      <view class="u-select">
        <view class="u-select__header" style="background-color:#fff" @touchmove.stop.prevent="">
          <view
          ...
          >
            ...
            >
              <view
                ...
                :key="index1"
              >
                <view class="u-line-1 f32">{{ item1[labelName] }}</view>
              </view>
            </picker-view-column>
          </picker-view>
          <view class="flex f-center">
            <view class="confirm-btn t-c f34 f-w6"
              hover-class="u-hover-class"
              :hover-stay-time="150"
              @touchmove.stop=""
              @tap.stop="getResult('confirm')"
